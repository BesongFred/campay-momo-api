...
type Transreq struct {
	...
	User        string `json:"external_user"`
}
...
func main() {
	...
	trans := post(apikey, number, amount, description)
...
func isValidnumber(number string) bool {
	re := regexp.MustCompile(`^(676|653|656|659|678)\d{6}$`)
...
func post(apik string, number string, amount string, description string) Transrep {
